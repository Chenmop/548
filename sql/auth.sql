...
insert  into `account`(`id`,`username`,`sha_pass_hash`,`sessionkey`,`v`,`s`,`token_key`,`email`,`reg_mail`,`joindate`,`last_ip`,`failed_logins`,`locked`,`lock_country`,`last_login`,`online`,`expansion`,`mutetime`,`mutereason`,`muteby`,`locale`,`os`,`recruiter`) values (1,'MEME','55C93E4C05E4D5126B805A0EEDF471603D2860BF','E71E95E8D31AE2E049BE92B4192AC78A95D57E697E15492CF8F1A6E2CF0773F8238E4728C1820BE2','6A3A41E138136FDA994F146419E4CE6F7A3DC494FB83A73EC0A75B19FB820FAC','F8CA7D625D04FD4ABA061FB427D4DE53C31C0DBF1FBC6F1D2513F3E4B05002D9','','','','2015-01-07 22:50:29','127.0.0.1',0,0,'00','2015-01-14 18:15:40',0,4,0,'','',0,'Win',0);
...
insert  into `account_access`(`id`,`gmlevel`,`RealmID`) values (0,3,1);
...
insert  into `realmcharacters`(`realmid`,`acctid`,`numchars`) values (1,1,6);
...
insert  into `realmlist`(`id`,`name`,`address`,`localAddress`,`localSubnetMask`,`port`,`icon`,`flag`,`timezone`,`allowedSecurityLevel`,`population`,`gamebuild`) values (1,'CaffCore','127.0.0.1','127.0.0.1','255.255.255.0',8085,0,0,1,0,0,18414);
...
insert  into `uptime`(`realmid`,`starttime`,`uptime`,`maxplayers`,`revision`) values (1,1420689012,0,0,'SkyFire 5.x.x rev. unknown 1970-01-01 00:00:00 +0000 (Archived branch) (Win32, Debug)');
insert  into `uptime`(`realmid`,`starttime`,`uptime`,`maxplayers`,`revision`) values (1,1420690056,600,0,'SkyFire 5.x.x rev. unknown 1970-01-01 00:00:00 +0000 (Archived branch) (Win32, Debug)');
insert  into `uptime`(`realmid`,`starttime`,`uptime`,`maxplayers`,`revision`) values (1,1420692994,0,0,'SkyFire 5.x.x rev. unknown 1970-01-01 00:00:00 +0000 (Archived branch) (Win32, Debug)');
insert  into `uptime`(`realmid`,`starttime`,`uptime`,`maxplayers`,`revision`) values (1,1420760018,601,1,'SkyFire 5.x.x rev. unknown 1970-01-01 00:00:00 +0000 (Archived branch) (Win32, Debug)');
insert  into `uptime`(`realmid`,`starttime`,`uptime`,`maxplayers`,`revision`) values (1,1420761380,0,0,'SkyFire 5.x.x rev. unknown 1970-01-01 00:00:00 +0000 (Archived branch) (Win32, Debug)');
insert  into `uptime`(`realmid`,`starttime`,`uptime`,`maxplayers`,`revision`) values (1,1420762953,600,1,'SkyFire 5.x.x rev. unknown 1970-01-01 00:00:00 +0000 (Archived branch) (Win32, Debug)');
insert  into `uptime`(`realmid`,`starttime`,`uptime`,`maxplayers`,`revision`) values (1,1421112130,2401,1,'SkyFire 5.x.x rev. unknown 1970-01-01 00:00:00 +0000 (Archived branch) (Win32, Debug)');
insert  into `uptime`(`realmid`,`starttime`,`uptime`,`maxplayers`,`revision`) values (1,1421116100,1200,1,'SkyFire 5.x.x rev. unknown 1970-01-01 00:00:00 +0000 (Archived branch) (Win32, Debug)');
insert  into `uptime`(`realmid`,`starttime`,`uptime`,`maxplayers`,`revision`) values (1,1421118471,0,0,'SkyFire 5.x.x rev. unknown 1970-01-01 00:00:00 +0000 (Archived branch) (Win32, Debug)');
insert  into `uptime`(`realmid`,`starttime`,`uptime`,`maxplayers`,`revision`) values (1,1421170523,0,0,'SkyFire 5.x.x rev. unknown 1970-01-01 00:00:00 +0000 (Archived branch) (Win32, Debug)');
insert  into `uptime`(`realmid`,`starttime`,`uptime`,`maxplayers`,`revision`) values (1,1421171259,0,0,'SkyFire 5.x.x rev. unknown 1970-01-01 00:00:00 +0000 (Archived branch) (Win32, Debug)');
insert  into `uptime`(`realmid`,`starttime`,`uptime`,`maxplayers`,`revision`) values (1,1421189905,601,1,'SkyFire 5.x.x rev. unknown 1970-01-01 00:00:00 +0000 (Archived branch) (Win32, Debug)');
insert  into `uptime`(`realmid`,`starttime`,`uptime`,`maxplayers`,`revision`) values (1,1421191031,0,0,'SkyFire 5.x.x rev. unknown 1970-01-01 00:00:00 +0000 (Archived branch) (Win32, Debug)');
insert  into `uptime`(`realmid`,`starttime`,`uptime`,`maxplayers`,`revision`) values (1,1421191906,0,0,'SkyFire 5.x.x rev. unknown 1970-01-01 00:00:00 +0000 (Archived branch) (Win32, Debug)');
insert  into `uptime`(`realmid`,`starttime`,`uptime`,`maxplayers`,`revision`) values (1,1421193105,0,0,'SkyFire 5.x.x rev. unknown 1970-01-01 00:00:00 +0000 (Archived branch) (Win32, Debug)');
insert  into `uptime`(`realmid`,`starttime`,`uptime`,`maxplayers`,`revision`) values (1,1421193836,600,1,'SkyFire 5.x.x rev. unknown 1970-01-01 00:00:00 +0000 (Archived branch) (Win32, Debug)');
insert  into `uptime`(`realmid`,`starttime`,`uptime`,`maxplayers`,`revision`) values (1,1421195122,0,0,'SkyFire 5.x.x rev. unknown 1970-01-01 00:00:00 +0000 (Archived branch) (Win32, Debug)');
insert  into `uptime`(`realmid`,`starttime`,`uptime`,`maxplayers`,`revision`) values (1,1421198263,1201,1,'SkyFire 5.x.x rev. unknown 1970-01-01 00:00:00 +0000 (Archived branch) (Win32, Debug)');
insert  into `uptime`(`realmid`,`starttime`,`uptime`,`maxplayers`,`revision`) values (1,1421200606,2401,1,'SkyFire 5.x.x rev. unknown 1970-01-01 00:00:00 +0000 (Archived branch) (Win32, Debug)');
insert  into `uptime`(`realmid`,`starttime`,`uptime`,`maxplayers`,`revision`) values (1,1421205326,0,0,'SkyFire 5.x.x rev. unknown 1970-01-01 00:00:00 +0000 (Archived branch) (Win32, Debug)');
insert  into `uptime`(`realmid`,`starttime`,`uptime`,`maxplayers`,`revision`) values (1,1421206677,601,1,'SkyFire 5.x.x rev. unknown 1970-01-01 00:00:00 +0000 (Archived branch) (Win32, Debug)');
insert  into `uptime`(`realmid`,`starttime`,`uptime`,`maxplayers`,`revision`) values (1,1421207661,0,0,'SkyFire 5.x.x rev. unknown 1970-01-01 00:00:00 +0000 (Archived branch) (Win32, Debug)');
insert  into `uptime`(`realmid`,`starttime`,`uptime`,`maxplayers`,`revision`) values (1,1421276246,601,1,'SkyFire 5.x.x rev. unknown 1970-01-01 00:00:00 +0000 (Archived branch) (Win32, Debug)');
insert  into `uptime`(`realmid`,`starttime`,`uptime`,`maxplayers`,`revision`) values (1,1421277326,600,1,'SkyFire 5.x.x rev. unknown 1970-01-01 00:00:00 +0000 (Archived branch) (Win32, Debug)');
insert  into `uptime`(`realmid`,`starttime`,`uptime`,`maxplayers`,`revision`) values (1,1421364858,0,0,'TrinityCoreRev: Archive Debug Rev hash: 92332d315 (Win32, little-endian)');
insert  into `uptime`(`realmid`,`starttime`,`uptime`,`maxplayers`,`revision`) values (1,1421366163,0,0,'TrinityCoreRev: Archive Debug Rev hash: 92332d315 (Win32, little-endian)');
insert  into `uptime`(`realmid`,`starttime`,`uptime`,`maxplayers`,`revision`) values (1,1421366674,605,0,'TrinityCoreRev: Archive Debug Rev hash: 92332d315 (Win32, little-endian)');
...
/*Data for the table `word_blacklist` */
